...
void loop()
{
  ...
  if ((pastLight > highPoint && ambientLight < highPoint) || (pastLight < highPoint && ambientLight > highPoint))
  {
    Blynk.notify("The Ambient Light Level passed the high point you set. The light level is " + lightLevel + ".");
  }
  else if ((pastLight < lowPoint && ambientLight > lowPoint) || (pastLight > lowPoint && ambientLight < lowPoint))
  {
